...
class HtmlExport(unittest.TestCase):
    ...
    def test_formatting(self):
        ...
        for text, html in (
            ...
            ('[aa.jpg:20x30 label]',
             '<img src="images/aa.jpg" alt="label" width="20" height="30" class="lcg-image image-aa"/>'),
            ('[>aa.jpg]',
             '<img src="images/aa.jpg" alt="" align="right" class="lcg-image right-aligned image-aa"/>'),
            ('[<aa.jpg]',
             '<img src="images/aa.jpg" alt="" align="left" class="lcg-image left-aligned image-aa"/>'),
            ('[aa.jpg label | descr]',
            ...
            ('[>aa.jpg bb.jpg label | descr]',
             '<a href="images/aa.jpg" title="descr"><img src="images/bb.jpg" alt="label" align="right" class="lcg-image right-aligned image-bb"/></a>'),
            ('[test bb.jpg bb]',
