...
class HtmlExport(unittest.TestCase):
    ...
    def test_formatting(self):
        ...
        for text, html in (
            ...
            # Inline images
            ('[aa.jpg]',
             '<img src="images/aa.jpg" alt="" border="0" class="lcg-image image-aa">'),
            ('*[aa.jpg]*',
             '<strong><img src="images/aa.jpg" alt="" border="0" class="lcg-image image-aa"></strong>'),
            ('[aa.jpg label]',
             '<img src="images/aa.jpg" alt="label" border="0" class="lcg-image image-aa">'),
            ('[aa.jpg:20x30 label]',
             '<img src="images/aa.jpg" alt="label" width="20" height="30" border="0" class="lcg-image image-aa">'),
            ('[>aa.jpg]',
             '<img src="images/aa.jpg" alt="" align="right" border="0" class="lcg-image right-aligned image-aa">'),
            ('[<aa.jpg]',
             '<img src="images/aa.jpg" alt="" align="left" border="0" class="lcg-image left-aligned image-aa">'),
            ('[aa.jpg label | descr]',
             '<img src="images/aa.jpg" alt="label: descr" border="0" class="lcg-image image-aa">'),
            ('[http://www.freebsoft.org/img/logo.gif Free(b)soft logo]',
             '<img src="http://www.freebsoft.org/img/logo.gif" alt="Free(b)soft logo" border="0" class="lcg-image image-logo">'),
            ('[cc.png]',
             '<img src="images/cc.png" alt="Image C: Nice picture" border="0" class="lcg-image image-cc">'),
            # Image links (links with an image instead of a label)
            ('[aa.jpg bb.jpg label | descr]',
             '<a href="images/aa.jpg" title="descr"><img src="images/bb.jpg" alt="label" border="0" class="lcg-image image-bb"></a>'),
            ('[aa.jpg bb.jpg | descr]',
             '<a href="images/aa.jpg" title="descr"><img src="images/bb.jpg" alt="" border="0" class="lcg-image image-bb"></a>'),
            ('[>aa.jpg bb.jpg label | descr]',
             '<a href="images/aa.jpg" title="descr"><img src="images/bb.jpg" alt="label" align="right" border="0" class="lcg-image right-aligned image-bb"></a>'),
            ('[test bb.jpg bb]',
             '<a href="test" title="Some description"><img src="images/bb.jpg" alt="bb" border="0" class="lcg-image image-bb"></a>'),
            ('[http://www.freebsoft.org /img/logo.gif]',
             '<a href="http://www.freebsoft.org"><img src="/img/logo.gif" alt="" border="0" class="lcg-image image-logo"></a>'),
            ('[http://www.freebsoft.org /img/logo.gif Free(b)soft website]',
             '<a href="http://www.freebsoft.org"><img src="/img/logo.gif" alt="Free(b)soft website" border="0" class="lcg-image image-logo"></a>'),
            ('[http://www.freebsoft.org /img/logo.gif Free(b)soft website | Go to Free(b)soft website]',
             '<a href="http://www.freebsoft.org" title="Go to Free(b)soft website"><img src="/img/logo.gif" alt="Free(b)soft website" border="0" class="lcg-image image-logo"></a>'),
            # Absolute image links
            ('http://www.freebsoft.org/img/logo.gif',
             '<img src="http://www.freebsoft.org/img/logo.gif" alt="" border="0" class="lcg-image image-logo">'),
            # Audio player links
            ('[xx.mp3]',
    ...
    def test_export(self):
        ...
        for content, html in (
            ...
            (lcg.Quotation(lcg.TextContent("blah"), source='Hugo', uri='http://hugo.org'),
             '<blockquote class="lcg-quotation">blah<footer>— <a href="http://hugo.org">Hugo</a></footer></blockquote>'),
            (lcg.NewPage(),
             '<hr class="new-page">'),
            (lcg.Substitution('x'),
             'value of x'),
