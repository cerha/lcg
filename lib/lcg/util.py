...
_LANGUAGE_NAMES = {
    ...
    'ca':'Catalan', 'co':'Corsican', 'cs':_('Czech'), 'cy':'Welsh',
    'da':'Danish', 'de':_('German'), 'dz':'Bhutani',
    'el':'Greek', 'en':_('English'), 'eo':'Esperanto', 'es':_('Spanish'),
    'et':'Estonian', 'eu':'Basque',
    'fa':'Persian', 'fi':'Finnish', 'fj':'Fiji', 'fo':'Faroese', 'fr':'French',
    'fy':'Frisian',
    'ga':'Irish', 'gd':'Scots Gaelic', 'gl':'Galician', 'gn':'Guarani',
    'gu':'Gujarati',
    ...
    'na':'Nauru', 'ne':'Nepali', 'nl':'Dutch', 'no':_('Norwegian'),
    ...
    'si':'Sinhalese', 'sk':_('Slovak'), 'sl':'Slovenian', 'sm':'Samoan',
